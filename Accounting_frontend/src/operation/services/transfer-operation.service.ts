...
export class TransferOperationService {
  ...
  public get(id: string = ''): Observable<TransferOperation[]> {
    ...
    return this.client.get<TransferOperation[]>(URL, { params });
  }

  public set(transfer: TransferOperation): Observable<TransferOperation> {
    ...
    return this.client.post<TransferOperation>(URL, stored);
  }
